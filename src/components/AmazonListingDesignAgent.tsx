...
export default function AmazonListingDesignAgent({ onShowPricing }: AmazonListingDesignAgentProps) {
    ...
    const generateDesignPlan = async () => {
        ...
        try {
            ...
            let analysisPrompt = `You are an expert Amazon listing designer. Analyze all the provided information to create a comprehensive ${currentPlan.toLowerCase().includes('free') ? '3' : '7'}-image Amazon listing design plan.
...
Create a complete design plan for ${currentPlan.toLowerCase().includes('free') ? '3' : '7'} Amazon listing images. Each image should serve a specific purpose in the customer journey.

CRITICAL: If generate 3 images, DO NOT include Images 4-7. Only provide Image 1, 2 and 3.
