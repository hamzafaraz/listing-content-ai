        ...
        try {
            ...
            const updateTimer = async () => {
                while (true) {
                    ...
                    else setProgress('Finalizing 7-image conversion focused design plan...');
            ...
            let analysisPrompt = `You are an expert Amazon listing designer. Analyze all the provided information to create a comprehensive 7-image Amazon listing design plan.
        ...
        "targetAudience": "Who is the target customer?",
            "competitorInsights": "What design patterns work in this niche?",
                "keySellingPoints": ["array of 5-7 key selling points to highlight"],
                    "designStrategy": "Overall strategy for the 7-image listing"
} `;
            ...
            const extractJson = (text: string) => {
                try {
                    // First try cleaning markdown code blocks
            ...
            // Step 2: Generate design plan for all 7 images
            setProgress('Step 2/3: Creating design plan for 7 images...');

            const designPrompt = `Based on this analysis:

${JSON.stringify(analysis, null, 2)}

Create a complete design plan for 7 Amazon listing images. Each image should serve a specific purpose in the customer journey.
    ...
    "images": [
        {
            ...
            "productDisplayPrompt": "REQUIRED FOR EVERY IMAGE. Start exactly with: 'High-resolution 2000x2000 pixel square product shot (1:1 aspect ratio)'. ABSOLUTELY NO TEXT, NO LETTERS, NO NUMBERS, NO OVERLAYS. Describe the products physical appearance EXACTLY as shown in the input images (color, shape, logo). DO NOT CHANGE THE PRODUCT."
        }
    ]
} `;
            ...
            setDesignPlan({
                analysis,
                images: designPlanResult.images
            });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4 md:p-8" id="app-root">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-xl p-6 md:p-8 mb-6 text-white">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm opacity-90">{designPlan.analysis.productAnalysis}</p>
                                </div>
                                <div>
                                    <p className="font-semibold mb-1">Target Audience:</p>
                                    <p className="text-sm opacity-90">{designPlan.analysis.targetAudience}</p>
                                </div>
                                <div className="md:col-span-2">
                                    <p className="font-semibold mb-1">Strategy:</p>
                                    <p className="text-sm opacity-90">{designPlan.analysis.designStrategy}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 mt-6">
                                <button
                                    onClick={downloadPDF}
                                    className="px-6 py-3 bg-white text-purple-600 rounded-lg font-bold hover:bg-gray-100 transition shadow-md flex items-center gap-2"
                                >
                                ...
                                <div key={index} className="bg-white rounded-xl shadow-xl p-6 md:p-8">
                                    ...
                                    <div className="mt-6 border-t pt-4 md:col-span-2">
                                        ...
                                        <div className="flex gap-2">
                                            <input
                                                type="text"
                                                placeholder="Tell the AI what to change (e.g., 'Make the headline punchier', 'Remove the badge')..."
                                                className="flex-1 p-2 border border-gray-300 rounded-lg text-sm focus:border-purple-500 outline-none text-gray-900 bg-white"
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 bg-orange-500 text-white rounded-lg text-sm font-bold hover:bg-orange-600 transition disabled:opacity-50 flex items-center gap-2"
                                            >
